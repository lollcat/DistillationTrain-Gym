...
#Agent = Agent(summary_writer=summary_writer, total_episodes=50, mem_length=4, batch_size=3)
Agent = Agent(summary_writer=summary_writer, total_episodes=100, mem_length=1000, batch_size=32)
